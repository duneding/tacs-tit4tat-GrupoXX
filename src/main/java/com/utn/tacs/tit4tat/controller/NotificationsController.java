...
public class NotificationsController {
	...
	/*
	 * @RequestMapping(value = "/edit", method = RequestMethod.PUT) public
	 * @ResponseBody String getItemsSearch(@RequestParam(value = "id") String
	 * id,
	 * 
	 * @RequestParam(value = "state") String state) {
	 * 
	 * try { this.solicitudService.changeStateOfSolicitud(id, state); } catch
	...
	public ModelAndView createGet() {
		...
		try {
			...
			itemOfrecido.setPermalink(new URL(
					"http://mercadolibre.com.ar/item/ml12312"));
			...
			itemSolicitado.setPermalink(new URL(
					"http://mercadolibre.com.ar/item/ml12312"));
	...
	public @ResponseBody ModelAndView share(
			@PathVariable("notId") String itemId,
